...
//get neighbours for an index. 

let neighbours = getNeighbours(index);
//this returns an array, maybe with some undefined elements. 

//figure out what type of cell this is. 

if (neighbours[0]==null&&neighbours[1]==null&&neighbours[2]==null&&neighbours[7]==null){
//this is the top-left-cell of the page. 
}
